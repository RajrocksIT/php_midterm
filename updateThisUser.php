...
<table class="table-style-three">
  ...
  <tr><td>Phone Number :</td>           <td><input type="text" name="pnumber" value="<?php print $userdetails['pnumber']; ?>"></td></tr>
    <tr><td>Serial : </td>      <td><input type="text" name="serial" value="<?php print $userdetails['serial'];?>"></td></tr>
  <?php } ?>
</table>
